...
// // import 'package:flutter_animate/flutter_animate.dart';
// // import 'package:google_fonts/google_fonts.dart';
// // import 'package:laza/Card/Providers/card-type-provider.dart';
// // import 'package:laza/Resources/Navigators/navigators.dart';
// // import 'package:laza/Resources/NotificationMassage/ToastMassage.dart';
// // import 'package:laza/Resources/Widgets/reuseable_appbar.dart';
// // import 'package:laza/Card/Screens/new_card_screen.dart';
// // import 'package:loading_animation_widget/loading_animation_widget.dart';
// // import 'package:provider/provider.dart';
// // import '../../Resources/MediaQuery/media_query.dart';
// // import '../../Resources/NavigationBar/nav_bar.dart';
...
// //                 // Check if card limit (3) is reached
// //                 bool isCardLimitReached = cards.length >= 3;
// //                 // Removed the automatic toast that was showing on every load
// //                 return _CardListView(
// //                   cards: cards,
// //                   selectedIndex: selectedIndex,
// //                   onSelect: (index) => setState(() => selectedIndex = index),
...
// //                           cards.length) // Show toast when trying to add
// //                       : () => NavigatorTo(context, const NewCardScreen()),
// //                   onSave: () {
// //                     statusOfCard = 'save';
// //                     if (navigatedFrom != 'navBar') {
...
// //                         selectedIndex = cards.length > 0 ? cards.length - 1 : 0;
// //                       }
// //                       // Update Firestore (assuming backend logic handles this)
// //                       final uid = FirebaseAuth.instance.currentUser!.uid;
// //                       FirebaseFirestore.instance
// //                           .collection('User')
// //                           .doc(uid)
...
// //   final int selectedIndex;
// //   final Function(int) onSelect;
// //   final VoidCallback? onAddCard; // Nullable to disable when limit reached
// //   final VoidCallback onSave;
// //   final Function(int) onDelete; // Added delete callback
...
// //                                   BoxShadow(
// //                                     color: isSelected
// //                                         ? MyColor.purple.withOpacity(0.4)
// //                                         : Colors.black.withOpacity(0.1),
// //                                     blurRadius: isSelected ? 25 : 15,
// //                                     offset: Offset(0, isSelected ? 12 : 8),
// //                                   ),
...
// //                                           image:
// //                                               AssetImage(PngImages.paymentCard),
// //                                           fit: BoxFit.cover,
// //                                         ),
// //                                       ),
// //                                     ),
...
// //             padding: const EdgeInsets.symmetric(horizontal: 20),
// //             child:
// //                 _AddCardButton(onTap: onAddCard ?? () {}), // Safe call if null
// //           ),
...
//     switch (cardType.toLowerCase()) {
//       case 'visa':
//         return [const Color(0xff93278F), const Color(0xff29ABE2)];
//       case 'mastercard':
//         return [Colors.orange, Colors.redAccent];
//       case 'paypal':
//         return [const Color(0xff0070ba), const Color(0xff003087)];
//       default:
//         return [MyColor.purple, MyColor.purple.withOpacity(0.8)];
//     }
//   }
...
//   final VoidCallback onSave;
//   final Function(int) onDelete;
//   final Function(String) getCardColors;
//   final Function(String) getCardBrand;
//   final Function(String) maskCardNumber;
...
//                     final cardColors = getCardColors(cardBrand.toLowerCase());
//                     final maskedCardNumber = maskCardNumber(cardNumber);
